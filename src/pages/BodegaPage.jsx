            ...
            <div className="hero-content">
              ...
              <div style={{ marginTop: '1rem', padding: '1rem', background: '#f5f5f5', borderRadius: '8px' }}>
                ...
                <button 
                  onClick={async () => {
                    try {
                      const health = await sourcingApi.healthCheck();
                      console.log('Health check:', health);
                      alert('✅ Backend conectado correctamente');
                    } catch (error) {
                      console.error('Health check failed:', error);
                      alert('❌ No se pudo conectar al backend: ' + error.message);
                    }
                  }}
                  style={{ marginRight: '1rem', padding: '0.5rem 1rem', background: '#007bff', color: 'white', border: 'none', borderRadius: '4px' }}
                >
                ...
                <button 
                  onClick={() => {
                    console.log('Current state:', { url, loading, searchResult });
